...
print_success() {
    ...
    echo ""
    echo -e "系统信息:"
    echo -e "  系统: ${YELLOW}$OS_PRETTY_NAME${NC}"
    echo -e "  架构: ${YELLOW}$ARCH_TYPE${NC}"
    ...
    echo ""
    echo "常用命令:"
    echo "  查看状态: systemctl status lxcmaster"
    echo "  查看日志: journalctl -u lxcmaster -f"
    echo "  重启服务: systemctl restart lxcmaster"
    echo "  停止服务: systemctl stop lxcmaster"
    echo ""
